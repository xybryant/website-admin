...
<body>
  ...
  <div class="main">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <form action="./api/page_add.php" method="post" class="col-sm-6">
          <div class="form-group">
            <label for="modulename">模块名</label>
            <input type="text" class="form-control" name="modulename" id="modulename" placeholder="模块名" autocomplete="off">
          </div>
           <div class="form-group">
